// Raccoon brand mark. Inline SVG with `fill="currentColor"` so it inherits the
// surrounding theme color. Shared by the login and welcome surfaces.
export function RaccoonLogo(props: { className?: string; size?: number }) {
  const size = props.size ?? 40
  return (
    <svg
      className={props.className ?? "login-logo"}
