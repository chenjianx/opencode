...
function RaccoonLogo() {
  return (
    <svg
      className="login-logo"
      viewBox="0 0 56.719255 56.719255"
      width="40"
      height="40"
      aria-hidden="true"
      xmlns="http://www.w3.org/2000/svg"
    >
      <g transform="matrix(0.26458333,0,0,0.26458333,-24.557963,-24.555715)" fill="currentColor">
        <path d="m234.28,180.82c-3.28,0 -5.94,2.66 -5.94,5.94c0,3.28 2.66,5.94 5.94,5.94c3.28,0 5.94,-2.66 5.94,-5.94c0,-3.28 -2.66,-5.94 -5.94,-5.94z" />
        <path d="m165.72,180.82c-3.28,0 -5.94,2.66 -5.94,5.94c0,3.28 2.66,5.94 5.94,5.94c3.28,0 5.94,-2.66 5.94,-5.94c-0.01,-3.28 -2.66,-5.94 -5.94,-5.94z" />
