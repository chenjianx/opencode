...
const TIPS: Tip[] = [
  ...
  // raccoon_change start - prefer raccoon config paths in user tips
  "Create {highlight}raccoon.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  "Place TUI settings in {highlight}~/.config/raccoon/tui.json{/highlight} for global config",
  // raccoon_change end
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.raccoon/commands/{/highlight} for reusable prompts", // raccoon_change - prefer raccoon project dir in tips
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.raccoon/agents/{/highlight} for specialized AI personas", // raccoon_change - prefer raccoon project dir in tips
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.raccoon/tools/{/highlight} to define new LLM tools", // raccoon_change - prefer raccoon project dir in tips
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.raccoon/plugins/{/highlight} for event hooks", // raccoon_change - prefer raccoon project dir in tips
  "Use plugins to send OS notifications when sessions complete",
  // raccoon_change start - rebrand CLI tips
  "Create a plugin to prevent Raccoon from reading sensitive files",
  "Use {highlight}raccoon run{/highlight} for non-interactive scripting",
  "Use {highlight}raccoon --continue{/highlight} to resume the last session",
  "Use {highlight}raccoon run -f file.ts{/highlight} to attach files via CLI",
  // raccoon_change end
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  // raccoon_change start - rebrand CLI tips
  "Run {highlight}raccoon serve{/highlight} for headless API access to Raccoon",
  "Use {highlight}raccoon run --attach{/highlight} to connect to a running server",
  "Run {highlight}raccoon upgrade{/highlight} to update to the latest version",
  ...
  "Run {highlight}raccoon debug config{/highlight} to troubleshoot configuration", // raccoon_change - rebrand CLI tip
