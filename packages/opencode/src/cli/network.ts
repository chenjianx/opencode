...
const options = {
  ...
  "mdns-domain": {
    type: "string" as const,
    describe: "custom domain name for mDNS service (default: raccoon.local)", // raccoon_change - rebrand mDNS default help
    default: "raccoon.local", // raccoon_change - rebrand mDNS default domain
  },
  cors: {
    type: "string" as const,
    array: true,
