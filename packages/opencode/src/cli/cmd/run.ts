...
export const RunCommand = effectCmd({
  command: "run [message..]",
  describe: "run Raccoon with a message", // raccoon_change - rebrand command description
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running Raccoon server (e.g., http://localhost:4096)", // raccoon_change - rebrand option description
      })
      .option("password", {
        alias: ["p"],
        type: "string",
...
export async function runMini(input: MiniCommandInput) {
  ...
  await RunCommand.handler({
    $0: "raccoon", // raccoon_change - rebrand synthetic mini command name
    _: ["mini"],
