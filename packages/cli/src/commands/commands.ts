...
export const Commands = Spec.make(typeof OPENCODE_CLI_NAME === "string" ? OPENCODE_CLI_NAME : "lildax", { // raccoon_change - rebrand CLI fallback name
  description: "Raccoon command line interface", // raccoon_change - rebrand CLI description
  commands: [
    Spec.make("api", {
